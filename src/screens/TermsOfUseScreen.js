    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.paragraph}>
          ...
          please don’t hesitate to contact us at jryansaunders@gmail.com. ​
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          YOU HEREBY AGREE THAT, BEFORE USING THE SERVICES, YOU WILL CONSULT
          YOUR PHYSICIAN, PARTICULARLY IF YOU ARE AT RISK FOR PROBLEMS RESULTING
          FROM PHYSICAL ACTIVITY OR EXERCISE OR LIFESTYLE CHANGES. You affirm
          that a physician has specifically approved your use of the Services.
          The Services are intended for use only by individuals healthy enough
          to perform physical activity and exercise, and are not intended for
          use by minors or individuals with any type of health condition that
          makes the kind of physical activity or exercise suggested by the
          Services unsafe or inappropriate. We reserve the right to deny you
          access to the Services for any reason or no reason, including if we
          determine, in our sole discretion, that you have certain medical
          conditions.
        </Text>
        <Text style={styles.paragraph}>
          The Company itself does not offer, and the Services do not constitute,
          medical or healthcare advice or services and no physician-patient
          relationship with the Company or any of its employees, officers, or
          agents is created or implied by you accessing or using the Service.
          The information and materials provided through the Services are
          provided purely for informational purposes. You should always seek the
          advice of a physician or other qualified healthcare provider who you
          personally know before starting, stopping, or modifying any treatment
          or medication.
        </Text>
        <Text style={styles.paragraph}>
          You understand that the Services are not a substitute for emergency
          services. THE SERVICES SHOULD NEVER BE USED AS A SUBSTITUTE FOR
          EMERGENCY CARE. If you are in a life threatening situation, feel that
          you are a danger to yourself or others, or are having thoughts of
          suicide, please call the 24-hr National Suicide Prevention Lifeline at
          and notify the relevant authorities. Your call will be routed to the
          crisis center near you. If your issue is an emergency, call 911
          immediately or go to your nearest emergency room. You acknowledge and
          understand that you should never delay seeking treatment from your
          primary care physician or other qualified healthcare professional.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          the law. You’re responsible for any activity associated with your
          account.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          or interact with the Services in a manner that: ​ Infringes or
          violates the intellectual property rights or any other rights of
          anyone else (including Company); Violates any law or regulation,
          including any applicable export control laws; Is harmful, fraudulent,
          deceptive, threatening, harassing, defamatory, obscene, or otherwise
          objectionable; Jeopardizes the security of your Company account or
          anyone else’s (such as allowing someone else to use the Service);
          ...
          codes; Runs Maillist, Listserv, any form of auto-responder or “spam”
          on the Services, or any processes that run or are activated while you
          are not logged into the Services, or that otherwise interfere with the
          proper working of the Services (including by placing an unreasonable
          load on the Services’ infrastructure); “Crawls,” “scrapes,” or
          “spiders” any page, data, or portion of or relating to the Services or
          Content (through use of manual or automated means); Copies or stores
          any significant portion of the Content; Decompiles, reverse engineers,
        ...
        <Text style={styles.title}>Changes to the Service </Text>
        <Text style={styles.paragraph}>
          ...
          for any reason, in our sole discretion, and without notice.
        </Text>
        ...
        <Text style={styles.paragraph}>
         ...
         Flexee is also free to terminate (or suspend access to) your use of the
          ...
          these Terms. Account termination may result in destruction of any
          Content associated with your account, so keep that in mind before you
          decide to terminate your account. Provisions that, by their nature,
          should survive termination of these Terms shall survive termination.
          By way of example, all of the following will survive termination: any
        ...
        <Text style={styles.paragraph}>
          ...
          AND HEREBY EXPRESSLY WAIVE ANY LAW OF ANY STATE OR TERRITORY WHICH
        ...
        <Text style={styles.paragraph}>
          ...
          behalf): (i) your Content or your access to or use of the Service;
        ...
        <Text style={styles.paragraph}>
          ...
          the laws of the State of Pennsylvania, without giving effect to any
          ...
          nevertheless agree that such portion will be deemed severable from
          these Terms of Use and will not affect the validity and enforceability
          of the remaining provisions, and the remaining provisions of the Terms
          of Use remain in full force and effect. Neither the course of conduct
          between the parties nor trade practice will act to modify the Terms of
          Use. These Terms of Use do not confer any third-party beneficiary
          ...
          United States has embargoed goods; or (b) to anyone on the U.S.
          Treasury Department's list of Specially Designated Nationals or the
          U.S. Commerce Department's Table of Deny Orders. By downloading any
          software related to the Service, you represent and warrant that you
          are not located in, under the control of, or a national or resident
          of, any such country or on any such list. The effective date of these
          Terms of Use is May 1, 2020. These Terms of Use were written in
          English (US). To the extent any translated version of these Terms of
